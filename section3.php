...
<label class="radio-inline"><input type="radio" name="optradio" value="Distinction">Distinction</label>
<label class="radio-inline"><input type="radio" name="optradio" value="Merit">Merit</label>
<label class="radio-inline"><input type="radio" name="optradio" value="Pass">Pass</label>
...
<?php
	if(isset($_POST["submit1"])){
			...
			$query = "UPDATE final_report SET s3_1 = '$optradio', s3_2 = '$comment', complete = 'Complete', Submitted=now() WHERE year = '$year' AND User_Name = '$user';";
				if(mysqli_query($conn, $query)){
					echo "Good job!";
					header( "refresh:1;url=EEviewMail.php?report_id=" . $_SESSION['last_id'] );					
					die;					
					}
		}
?>
