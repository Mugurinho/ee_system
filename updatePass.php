            ...
            <div class="navbar-header">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
							...
							<li class="active"><a href="updatePass.php">Update password</a></li>
...
echo "Current password not match, try again!";
exit();
}
else{
$user = $_SESSION['User_Name'];//query for user 2 
	$list = mysqli_query($conn, "select * from User where User_Name = '$user'");
	while($Admin = mysqli_fetch_array($list)){
	$user = $Admin['User_ID']; //this code displays the admin ID
	}
