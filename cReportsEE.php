...
$sql = mysqli_query($conn, "select * from final_report inner join User on final_report.User_Name=User.User_Name where final_report.User_Name = '$user'");
		$no=1;
		while ($data = mysqli_fetch_array($sql))
		{
			...
			<td><a href="viewEE.php?report_id=<?php echo $data['report_id'] ?>"<?php echo $data['complete'] ?></td>View report</a></td>
			<td><a href="view3.php?report_id=<?php echo $data['report_id'] ?>">View Response</td>	
			</tr>
			<?php
		}	
		?>
